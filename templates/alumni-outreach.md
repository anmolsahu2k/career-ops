# Alumni Outreach Templates (Track A2)

For LinkedIn DMs, CMU Alumni Online Community ([community.cmu.edu/s/](https://community.cmu.edu/s/)), and Tartan Connect.

**No em-dashes. No CPT/visa explainer paragraphs. No "passionate about" / "leveraged" / "results-oriented" boilerplate.**
...
internally, I'd really appreciate it. Happy to send my resume and the role
link.
...
information, not just a referral.
...
Companies where this variant applies: **Red Hat** (Hack APAC 1st, $10K), **Symbl.ai**
(Integrate to Disrupt 2nd, $3K), **DataStax** (Build Modern Data App, Jury Award $3K),
**Route Mobile** (RAPID Hackathon 2nd, $5.5K).

---

## How to use

1. Open CMU Alumni Online Community ([community.cmu.edu/s/](https://community.cmu.edu/s/)) or LinkedIn
...
- Default cold response rate: ~5-8%
- CMU-to-CMU response rate: ~20-30% (much higher than non-alumni)
- Variant B (targeted engineer) response rate: ~15-25%
- Variant D (winner-angle): ~30-40% if the contact still works at the company

Plan for ~5-10 useful conversations from 30 messages. Roughly 2-3 actual referrals from those. The rest is volume.
