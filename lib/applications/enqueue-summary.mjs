import { atsFor, rolloutAllowlist } from './ats.mjs';
 ...
 * APPLY/CONSIDER token), and existing attempt states grouped by blocker.
 */
export function applicationQueuePreview(target, { config = null } = {}) {
  const diagnosed = diagnoseTrackerRows(target, { allowedAts: rolloutAllowlist(config) });
